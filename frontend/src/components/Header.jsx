...
export default function Header() {
    ...
    return (
        <>
            <div>
                <div className="flex    pl-8 pr-8  flex-row w-full bg-[#f8f6f0]">
                    <div className="flex  w-1/2  items-center gap-4" >
                        {/* <div className="flex flex-col justify-center text-xl font-extrabold">
                        BLOG
                       </div> */}
                        <div className="w-36 h-16  flex flex-col justify-center ">
                            <img src="	https://www.advisorpedia.com/static/assets/img/advisorpedia-logo_dark-version-transparent.png?v=1.2" alt="Blogger Icon" />
                        </div>
                    </div>
                    <div className="flex  w-1/2 gap-8 justify-end p-3 items-center" >
                        ...
                        <div
                            className="h-9 w-9 rounded-full bg-[#4102a6] flex justify-center items-center pl-[0.25px] hover:inset-2 cursor-pointer hover:scale-110 motion-reduce:transform-none"
                            onClick={onClick}
                        >
                            <div
                                className="h-7 w-7"
